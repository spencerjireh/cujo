...
| TrueForge → sandbox | Daytona API, then commands inside the box | Clone URLs at two SHAs, dependency names, `sniff.py`, subagent commands | Daytona key on the server; nothing in the box |
