...
98. [Cujo leads the card, the opener closes it, and the sections breathe](#98-cujo-leads-the-card-the-opener-closes-it-and-the-sections-breathe)
...
**Allocation reversed by 98.** The first half of the title stands — the ping's
embed, the checks wording, the grouped criticals, the pull-request link and
the run-page metadata are untouched. 98 puts Cujo back on the author line and
...
## 98. Cujo leads the card, the opener closes it, and the sections breathe
