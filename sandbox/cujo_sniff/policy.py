...
# hand back (decision 146), and one that listed a package store outside the
# tree ran past a run's token budget (decision 166). Every sensitive row is
# kept whatever the count.
MAX_FS_CHANGES = 200
