...
describe("parseCommand", () => {
  ...
  it("ignores a comment that is not a command", () => {
    ...
    expect(verbOf("/cujodismiss")).toBe("none");
  });
  ...
  it("refuses a verb buried in a sentence", () => {
    ...
    expect(verbOf("/cujo dismiss this is malware")).toBe("none");
    expect(verbOf("I would /cujo dismiss but I am not sure")).toBe("none");
