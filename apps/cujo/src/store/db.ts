...
export const SCHEMA = `
  ...
  -- Conversation runs in its own harness session, always (decision 47). Its
  ...
  -- \`CREATE TABLE IF NOT EXISTS\` runs on every open, so it reaches a deployed
  -- database on its own (decision 25).
