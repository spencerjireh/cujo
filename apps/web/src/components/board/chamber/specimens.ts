 ...
 *
 * A run is a star system (decision 81). The core is the star: the verdict, in
 ...
 * seeded off the run's id (decision 82): its radius is how long the check
 ...
 * passed was the strobe decision 82 removed — it is the glow swelling. A live
