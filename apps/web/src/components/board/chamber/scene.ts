 ...
 *
 * The rules, from decision 68 as amended by 78, 79, 80 and 81:
 *
 ...
 *   are decorative and carry no data. That is the whole of decision 78, and it
 ...
 *   of its id and means nothing (decision 79).
...
export function createChamber(options: ChamberOptions): ChamberHandle {
   ...
   * `placeAt`, seeded off the run's id and carrying nothing (decision 79). A
