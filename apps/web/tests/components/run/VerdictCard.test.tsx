...
/**
 * What the card is since decision 100: the verdict alone.
 *
 ...
 * hold is the absence decision 100 made. The counts are asserted alongside
...
describe("the verdict card does not link out (decision 100)", () => {
